...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="rooms.html" class="nav-link">Servicios</a></li>
	          <li class="nav-item"><a href="restaurant.html" class="nav-link">Cafetería</a></li>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/orange.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Inicio</a></span> <span class="mr-2"><a href="rooms.html">Rooms</a></span> <span>Rooms Single</span></p>
	            <h1 class="mb-4 bread">Detalle de Servicios</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/balayage_naraja_negro.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/naranja.jpg);"></div>
          				</div>
          				
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Balayage naranja negro <span></span></h2>
    						<p>El naranja no solo es un color. También es una actitud.</p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul class="list">
	    							<li><span>Duración de tinte:</span> 2 meses</li>
	    							<li><span>Calidad:</span> Alta</li>
	    						</ul>
	    						<ul class="list ml-md-5">
	    							<li><span>Tatamiento capilar:</span> Si</li>
	    							<li><span>Brillo:</span> Alto</li>
	    						</ul>
                  <ul class="list ml-md-5">
	    							<li><span>Color:</span>Negro naranja</li>
	    							
	    						</ul>
    						</div>
    						<p>Cuidamos tu cabello utilizando los mejores poductos de la mejor calidad para darle el mejor estilo que deseas a tu cabello, estas en manos profesionales relajate y disfruta los combio que estan por suceder.</p>
          		</div>
          ...
          <div class="col-lg-4 sidebar ftco-animate pl-md-5">
            ...
            <div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
              <h4 class="mb-4">Revisión &amp; Valoración</h4>
              <div class="row">
                <div class="col-md-6">
