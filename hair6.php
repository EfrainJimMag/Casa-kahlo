...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/nailport.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Inicio</a></span> <span class="mr-2"><a href="rooms.html">Rooms</a></span> <span>Rooms Single</span></p>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/mani1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/mani2.jpg);"></div>
          				</div>
          				
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Elegancia en tus uñas <span></span></h2>
    						<p>El rosa no solo es un color. También es una actitud.</p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul class="list">
	    							<li><span>Duración de uñas:</span> 3 meses</li>
	    							<li><span>Calidad:</span> Alta</li>
	    						</ul>
	    						<ul class="list ml-md-5">
	    							<li><span>Tatamiento de cuticula:</span> Si</li>
	    							<li><span>Brillo:</span> Alto</li>
	    						</ul>
                  <ul class="list ml-md-5">
	    							<li><span>Colores:</span>Cualquiera</li>
	    							
	    						</ul>
    						</div>
    						<p>Cuidamos tus uñas utilizando los mejores poductos de la mejor calidad para darle el mejor estilo que deseas a tus uñas, estas en manos profesionales relajate y disfruta los combio que estan por suceder.</p>
          		</div>
