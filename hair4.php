...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/makeup1.jpg');">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/makeup3.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/makeup4.jpg);"></div>
          				</div>
          				
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Maquillaje de fiesta u ocasión especial. <span></span></h2>
    						<p>El maquillaje es arte, la belleza es espiritu.</p>
                  ...
                  <ul class="list ml-md-5">
	    							<li><span>Color:</span>A tu preferencia</li>
	    							
	    						</ul>
    						</div>
    						<p>Cuidamos tu piel utilizando los mejores poductos de la mejor calidad para darle a tu piel el cuidado que se merese, estas en manos profesionales relajate y disfruta los combio que estan por suceder.</p>
          		</div>
