...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="rooms.php" class="nav-link">Servicios</a></li>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/extension2.png');">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/balayage_ex.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/extension3.jpg);"></div>
          				</div>
          				
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Balayage con extensiones <span></span></h2>
    						<p>Tu cabello es sensacional natural, dale un toque excepcional con extensiones.</p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul class="list">
	    							<li><span>Duración de extensiones:</span> 2 meses</li>
                  ...
                  <ul class="list ml-md-5">
	    							<li><span>Color:</span>De tu preferencia</li>
