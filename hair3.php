...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/boda_peinado.jpg');">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/novia2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/novia3.jpg);"></div>
          				</div>
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			...
          			<h2 class="mb-4">Peinado especial. <span></span></h2>
    						
                      <p>El peinado correcto pude convertir a una mujer común en hermosa y a una mujer hermosa en inolvidable. </p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul class="list">
	    							<li><span>Duración de peinado:</span> 1 día</li>
	    							<li><span>Calidad:</span> Alta</li>
	    						</ul>
	    						<ul class="list ml-md-5">
	    							<li><span>Resistencia</span> Alta</li>
	    							<li><span>Brillo:</span> Medio</li>
	    						</ul>
                  <ul class="list ml-md-5">
	    							<li><span>Ocasión:</span>Boda</li>
	    							
	    						</ul>
    						</div>
    						<p>Cuidamos tu cabello utilizando los mejores poductos de la mejor calidad para darle el mejor estilo que deseas a tu cabello, estas en manos profesionales relajate y disfruta los combio que estan por</p>
          		</div>
