...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="cafeteria.php" class="nav-link">Cafetería</a></li>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/cafe_kahlo.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Inicio</a></span> <span>Cafetería</span></p>
	            <h1 class="mb-4 bread">Cafetería</h1>
            </div>
          </div>
        </div>
      </div>
    		...
    		<div class="row">
    			<div class="col-md-6">
      			<div class="single-slider-resto mb-4 mb-md-0 owl-carousel">
      				<div class="item">
      					<div class="resto-img rounded" style="background-image: url(images/h_mr.png);"></div>
      				</div>
      				<div class="item">
      					<div class="resto-img rounded" style="background-image: url(images/h_az.png);"></div>
      				</div>
      				<div class="item">
      					<div class="resto-img rounded" style="background-image: url(images/h_na.png);"></div>
      				</div>
      			</div>
    			</div>
	            ...
	            <h2 class="mb-4">CasaKahlo Cafetería</h2>
	          </div>
	          <p>Tu cabello es la corona que nunca te quitas y al que debes de tratar con delicadesa cuidandolo como lo mas preciado de tu persona.</p>
	          <p></p>
	          <p><a href="#" class="btn btn-secondary rounded">Mas información</a></p>
    			</div>
    		</div>
    	</div>
    </section>
